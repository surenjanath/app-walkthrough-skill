...
const DETAILS = {
  intro: {
    ...
    body: "This is the web-platform run of the same demo shown in the repo's mobile example — same fictional brand, same app-walkthrough skill, a different frame around the output because platform: \"web\" was set in script.json.",
    bullets: [
      "Landscape 1920x1080 video with a browser-chrome mockup instead of a phone frame",
      "This PDF uses a wide browser frame stacked above the copy instead of a narrow phone frame beside it",
    ],
  },
  homepage: {
    kicker: "Marketing site",
    body: "The homepage leads with one clear value statement and a single primary call to action, reachable before any sign-in.",
    bullets: ["Secondary CTA for visitors who want to learn more before committing"],
  },
  dashboard: {
    kicker: "Web app",
    body: "The signed-in dashboard surfaces membership status, points balance, and progress toward the next tier in one view.",
    bullets: ["Sidebar navigation persists across every authenticated page"],
  },
  offers: {
    kicker: "Partner network",
    body: "A searchable grid of every active partner discount, with the flagship partner pinned above the rest.",
    bullets: ["Same underlying data model as the mobile app's Offers tab"],
  },
  settings: {
    kicker: "Account",
    body: "Notification preferences and account security, including two-factor authentication.",
    bullets: ["Consistent with the mobile app's Settings screen, adapted to a web layout"],
  },
  outro: {
    kicker: "Try it yourself",
    body: "Point the app-walkthrough skill at your own website or web app to generate the real thing — set platform: \"web\" in script.json and everything else follows automatically.",
    bullets: ["See the skill's README and SKILL.md for setup"],
  },
};
